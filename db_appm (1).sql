...
CREATE TABLE `tb_pengaduan` (
  ...
  `status` enum('tunggu','proses','selesai','ditolak') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(23414, 41615, '2023-01-21', 'terst', 'asdsdffgfdgfdgfd', 'test.png', 'tunggu'),
(32564, 41615, '2023-01-23', 'Test Date', 'TEST CURDATE', '1.png', 'proses'),
(50534, 41615, '2023-01-26', 'Test', '&lt;p&gt;123123&lt;/p&gt;', 'laporan0517.png', 'selesai'),
(325643, 55433, '2023-02-23', 'test', 'test', 'test.png', 'tunggu');
