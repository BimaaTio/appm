            ...
            <tbody>
              ...
              foreach ($dataLap as $dl) : ?>
                ...
                <tr id="<?= $dl['id_p'] ?>">
                  ...
                  <td>
                    <?php if ($dl['status'] === 'proses' || $dl['status'] === 'tunggu') : ?>
                      <a href="#" data-role="ubahStatus" data-id="<?= $dl['id_p'] ?>" class="btn btn-sm btn-warning" data-toggle="modal" data-target="#status">Ubah Status</a>
                    <?php endif; ?>
